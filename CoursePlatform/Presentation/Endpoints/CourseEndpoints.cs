...
using CoursePlatform.Application.Features.Courses.Queries.GetAllCourses;
using CoursePlatform.Application.Features.Courses.Queries.GetCourseById;
using CoursePlatform.Application.Features.Courses.Queries.GetCourseWithInstructor;
